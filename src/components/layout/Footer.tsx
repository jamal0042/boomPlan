      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-2xl font-bold">BoomPlan</span>
            </div>
            <p className="text-gray-400 mb-4">
              participer , Creer des evenements inoubliables et experimenter de ce que BoomPlan vous proposent.
            </p>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-lg font-semibold mb-4">Liens Basique</h3>
            <ul className="space-y-2">
              <li>
                <Link to="/events" className="text-gray-400 hover:text-white transition-colors">
                  Parcourir les Evenemnents
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © 2025 Boomplan for JamalTechnology. tous les droits reservee.
          </p>
